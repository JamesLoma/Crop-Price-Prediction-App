...
# Define the create_prediction_model function
def create_prediction_model():
    ...
    st.write("Welcome to the Crop Price Prediction App. Enter your details and we'll predict the crop price for you!")
...
# Call the create_prediction_model function
